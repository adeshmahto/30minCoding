...
import com.coding.web.dto.RegisterRequest;
...
public class AuthService {
    ...
    public void signup(RegisterRequest registerRequest) {
        ...
        mailService.sendEmail(new NotificationEmail("Please Activate your Account",
                user.getEmail(), "Thank you for signing up to 30 Min Coding, " +
                "please click on the below url to activate your account : " +
                "https://localhost:9092/api/auth/accountVerification/" + token));
    }
